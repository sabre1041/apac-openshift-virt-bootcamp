...
If you would like to learn more about OpenShift Virtualization, please visit the https://www.redhat.com/en/technologies/cloud-computing/openshift/virtualization[landing page], review the https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/virtualization/index[documentation], verify the list of https://access.redhat.com/articles/4234591[supported operating systems] in OpenShift Virtualization, check the details to https://docs.redhat.com/en/documentation/migration_toolkit_for_virtualization/2.11/html/planning_your_migration_to_red_hat_openshift_virtualization/index[plan a migration] and https://docs.redhat.com/en/documentation/migration_toolkit_for_virtualization/2.11/html/migrating_your_virtual_machines_to_red_hat_openshift_virtualization/index[run a migration plan], or view some of our demo videos on https://www.youtube.com/playlist?list=PLaR6Rq6Z4IqeQeTosfoFzTyE_QmWZW6n_[YouTube].

In addition to these documents, Red Hat has published guides to assist customers with the deployment and operation of OpenShift Virtualization:

* https://red.ht/virtarchguide[Architecture guide], providing a reference architecture for OpenShift Virtualization
* https://red.ht/virtrefguide[Example architecture], providing a practical example using the principles found in the architecture guide
* https://red.ht/virtsizing[Cluster sizing guide], to size an OpenShift cluster to host virtual machines
* https://access.redhat.com/articles/6994974[Tuning and scaling guide], to fine-tune cluster scalability and VM performances
* https://red.ht/virtcheatsheet[Cheat sheet for VMware administrators], to assist VMware administrators in mapping VMware features to corresponding OpenShift capabilities
